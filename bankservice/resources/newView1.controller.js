sap.ui.controller("bankservice.resources.newView1", {
	...
	onInit: function() {
		...
		jQuery.sap.require("bankservice.resources.utils.connectivity");
...
//	}	
	...
	displayBank:function(oModel){
		
		var oTable = sap.ui.getCore().byId("ID_BankTable");
